...
/**
 * The sender represents a sender of information over a socket. A sender writes
 * a message thorugh a printwriter over the socket to the receiver.
 * 
 * @author Patrick Lee
 * @version May 26, 2014
 * @author Period: 2
...
public class Sender extends Thread
{
     ...
     * 
     * @param w
     *            The NetworkWorld object to display notifications
     * @param n
    ...
    /**
     * Main loop of the Sender. Checks every second for alive. Closes sockets
     * once alive is set to false.
     */
    public void run()
    {
        while ( alive ) // main loop run basically while true
        {
            try
            {
